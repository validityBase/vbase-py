...
class AggregateIndexingService(IndexingService):
    ...
    def find_user_objects(self, user: str, return_set_cids=False) -> list[dict]:
        ...
        """
        all_results = self._execute_with_aggregation('find_user_objects', user, return_set_cids=return_set_cids)
        return self._aggregate_by_transaction_hash(all_results)
    ...
    def find_user_set_objects(self, user: str, set_cid: str) -> list[dict]:
        ...
        """
        all_results = self._execute_with_aggregation('find_user_set_objects', user, set_cid)
        return self._aggregate_by_transaction_hash(all_results)

    def _get_latest_by_timestamp(self, all_results: list, timestamp_key: str = "timestamp") -> dict | None:
        """
    ...
    def find_last_user_set_object(self, user: str, set_cid: str) -> dict | None:
        ...
        """
        all_results = self._execute_with_aggregation('find_last_user_set_object', user, set_cid)
    ...
    def find_objects(self, object_cids: list[str], return_set_cids=False) -> list[dict]:
        ...
        """
        all_results = self._execute_with_aggregation('find_objects', object_cids, return_set_cids=return_set_cids)
        return self._aggregate_by_transaction_hash(all_results)
    ...
    def find_object(self, object_cid: str, return_set_cids=False) -> list[dict]:
        ...
        """
        all_results = self._execute_with_aggregation('find_object', object_cid, return_set_cids=return_set_cids)
    ...
    def find_last_object(self, object_cid: str, return_set_cid=False) -> dict | None:
        ...
        """
        all_results = self._execute_with_aggregation('find_last_object', object_cid, return_set_cid=return_set_cid)
        return self._get_latest_by_timestamp(all_results)
