...
class ChainSetMatchingService(BaseSetMatchingService):
    ...
    This service executes matching strategies in order, and returns the first non-empty result. If all strategies return empty results, it returns an empty list.
    """
