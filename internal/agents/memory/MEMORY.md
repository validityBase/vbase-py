...
- Runtime, development, test, documentation, and lock-tooling dependency inputs live under `requirements/src/`.
- Generated lock files live under `requirements/lock/`; they must include pinned versions and hashes.
